...
/**
 * The purpose of this example is to show the lifetime of a
 * packet in the LTE network stack.
 *
 * It will generate:
 * - a ancestry.dot file containing a graph with the packets ancestry
 * - a stacktrace.dot file containing the network steps crossed by each packet
 */

NS_LOG_COMPONENT_DEFINE("PacketTraceOrigins");
...
main(int argc, char* argv[])
{
    ...
    Packet::SavePacketAncestryDot("ancestry.dot");
    Packet::SavePacketStackTraceDot("stacktrace.dot");
    Simulator::Destroy();
    return 0;
}
