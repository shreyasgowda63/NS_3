...
#ifndef IPV4_MULTICAST_FLOW_CLASSIFIER_H
#define IPV4_MULTICAST_FLOW_CLASSIFIER_H
...
class Ipv4MulticastFlowClassifier : public MulticastFlowClassifier
{
public:
  ...
  /// \param flowId the MulticastFlowId to search for
  /// \returns the FiveTuple corresponding to flowId
  FiveTuple FindMulticastFlow (MulticastFlowId flowId) const;
  ...
  std::vector<std::pair<Ipv4Header::DscpType, uint32_t> > GetDscpCounts (MulticastFlowId flowId) const;

private:

  /// Map to Flows Identifiers to MulticastFlowIds
  std::map<FiveTuple, MulticastFlowId> m_mcastFlowMap;
  /// Map to MulticastFlowIds to MulticastFlowPacketId
  std::map<MulticastFlowId, MulticastFlowPacketId> m_mcastFlowPktIdMap;
  /// Map MulticastFlowIds to (DSCP value, packet count) pairs
  std::map<MulticastFlowId, std::map<Ipv4Header::DscpType, uint32_t> > m_mcastFlowDscpMap;
 ...
 */
bool operator < (const Ipv4MulticastFlowClassifier::FiveTuple &t1, const Ipv4MulticastFlowClassifier::FiveTuple &t2);
...
#endif /* IPV4_MULTICAST_FLOW_CLASSIFIER_H */
