...
class Ipv4FlowClassifier : public FlowClassifier
{
  public:
    ...
    struct FiveTupleHash
    {
        ...
        std::size_t operator()(const FiveTuple& tuple) const
        {
            ...
            std::size_t h1 = Ipv4AddressHash()(tuple.sourceAddress);
            std::size_t h2 = Ipv4AddressHash()(tuple.destinationAddress);
  ...
  private:
    ...
    std::unordered_map<FlowId, std::unordered_map<Ipv4Header::DscpType, uint32_t>> m_flowDscpMap;
};
