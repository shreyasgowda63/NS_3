...
//     mn1           mn2
//
//  The distance between the two ARs (AR and HA) is 100 
// and they are connected via a PointToPoint link.
// It aims to show behaviour when a mobile node disconnects from home link and joins another ar
// and another node joins the home link disconnecting from an ar.
