...
//     mn
//
//  The distance between the two ARs is 40 and they are both connected to 
// the Home agent via a PointToPoint link.
// The mobile node does not go out of range of ar1 when it reaches the range of ar2
...
int main (int argc, char** argv)
{
  ...
  positionAlloc->Add (Vector (-20.0, 20.0, 0.0)); //AR1
  positionAlloc->Add (Vector (0.0, 20.0, 0.0)); //HA
  positionAlloc->Add (Vector (20.0, 20.0, 0.0)); //AR2
