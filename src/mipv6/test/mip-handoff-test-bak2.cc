...
private:
  ...
  uint64_t d; // False if MN to CN and true if CN to MN from uint8_t
...
*/
  ...
  Ptr<Application> capp2 = mn->GetApplication (0);
  ...
  */
  ...
  Simulator::Schedule (Time (Seconds (5.1)), &HandoffTestCase::Initialize, this, 0);
  Simulator::Schedule (Time (Seconds (14.0)), &HandoffTestCase::Test, this);

  //Check the test for 10 Kbps speed
  Simulator::Schedule (Time (Seconds (14.1)), &HandoffTestCase::Initialize, this, 0);
  ...
  Simulator::Schedule (Time (Seconds (28.1)), &HandoffTestCase::Initialize, this, 0);
  ...
  Simulator::Schedule (Time (Seconds (56.1)), &HandoffTestCase::Initialize, this, 0);
...
void HandoffTestCase::InstallApplications ()
{
  ...
  ApplicationContainer serverapps = server2.Install (cn);      
  ...
  ApplicationContainer clientapps = client2.Install (mn);
...
void HandoffTestCase::Test ()
{
  ...
  NS_TEST_ASSERT_MSG_GT_OR_EQ (pktcounter, pktcounterathandoff, "Handoff is not successful"); //chng gt -> gt||eq
...
{
  std::clog << "received ba " << "pktcounter=" << pktcounter << "\n";
