  ...
  if (!m_promiscRxCallback.IsNull ())
    {
      ...
      m_promiscRxCallback (Ptr<VirtualNetDevice> (this), packet, protocol, source, destination, packetType);
    }
  ...
  if (packetType != PACKET_OTHERHOST)
    {
      ...
      m_macRxTrace (packet);
      return m_rxCallback (Ptr<VirtualNetDevice> (this), packet, protocol, source);
    }
  return true;
}
