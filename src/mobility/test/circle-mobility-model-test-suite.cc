...
{
public:
  circlemobilitymodelTestSuite ();
};

circlemobilitymodelTestSuite::circlemobilitymodelTestSuite ()
  : TestSuite ("CircleMobilityModel", UNIT)
{
...
static circlemobilitymodelTestSuite CircleMobilityModelTestSuite;
