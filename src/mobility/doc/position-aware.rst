...
This module allows spatial indexing to be utilized for clipping reception events

This module allows for more efficient simulation of geographic protocols.