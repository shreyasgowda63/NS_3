...
void
ZigbeeNwkHeader::SetFrameType(enum ZigbeeNwkType zigbeeNwkType)
{
    m_fctrlFrmType = zigbeeNwkType;
}
...
{
    m_fctrlFrmType = static_cast<ZigbeeNwkType>((frameControl) & (0x03));            // Bit 0-1
