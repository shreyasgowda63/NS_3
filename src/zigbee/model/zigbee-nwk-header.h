...
{
    SUPPRESS = 0, //!< Suppress route discovery
    ENABLE = 1    //!< Enable route discovery
};
...
class ZigbeeNwkHeader : public Header
{
  ...
  private:
    ...
    MulticastMode m_mcstMode;     //!< Multicast mode sub-field (Bits 0-1)
