...
public:
  ...
  /**
   * Set the event set to use when ordering events with the same timestamp
   *
   * \param factory A factory configured to create EventSet objects
   */
  virtual void SetEventSet (ObjectFactory factory) = 0;
