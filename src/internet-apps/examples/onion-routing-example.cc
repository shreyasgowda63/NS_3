 ...
 *
 * 
 * The given example can be used to construct onion messagess of the following features:
...
public:
  ...
  virtual int EncryptLayer (uint8_t * ciphertext, uint8_t* message, int len, uint8_t * key) const;
  //implement decryption
  virtual int DecryptLayer (uint8_t * innerLayer, uint8_t* onion, uint16_t onionLen, uint8_t * pk, uint8_t * sk) const;
...
OnionManager::OnionManager ()
  : OnionRouting (crypto_box_SEALBYTES,AddressType::IPV4)
{}
...
int OnionManager::EncryptLayer (uint8_t * ciphertext, uint8_t* message, int len, uint8_t * key) const
{
...
int OnionManager::DecryptLayer (uint8_t * innerLayer, uint8_t* onion, uint16_t onionLen, uint8_t * pk, uint8_t * sk) const
{
