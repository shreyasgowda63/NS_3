  ...
  m_numOfPacketDrops (0)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (channelDelay.IsPositive (), true, "Propagation time of the Packet is not positive");
  ...
  if (m_useIpv6)
    {
      ...
      NS_TEST_ASSERT_MSG_EQ (ipv6Ifs.GetN (), 1, "Interface size is not equal to 1");
  ...
  else
    {
      ...
      NS_TEST_ASSERT_MSG_EQ (ipv4Ifs.GetN (), 1, "Interface size is not equal to 1");
