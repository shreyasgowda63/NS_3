...
class BlockAckAgreement
{
  ...
  protected:
    ...
    uint8_t m_amsduSupported{0}; //!< Flag whether MSDU aggregation is supported
    uint8_t m_blockAckPolicy{1}; //!< Type of block ack: immediate or delayed
    ...
    uint8_t m_htSupported{0};    //!< Flag whether HT is supported
