...
class WifiPhyOperatingChannel
{
  public:
     ...
     */
    int64_t GetPrimaryChannelCenterFrequency(ChannelWidthMhz primaryChannelWidth) const;
     ...
     */
    int64_t GetSecondaryChannelCenterFrequency(ChannelWidthMhz secondaryChannelWidth) const;
