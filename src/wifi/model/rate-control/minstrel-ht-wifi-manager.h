...
class MinstrelHtWifiManager : public WifiRemoteStationManager
{
  ...
  private:
     ...
     */
    uint8_t GetHtGroupId(uint8_t txstreams, Time gi, ChannelWidthMhz chWidth);
     ...
     */
    uint8_t GetVhtGroupId(uint8_t txstreams, Time gi, ChannelWidthMhz chWidth);
     ...
     */
    uint8_t GetHeGroupId(uint8_t txstreams, Time gi, ChannelWidthMhz chWidth);
