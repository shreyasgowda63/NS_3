 ...
 */
const std::map<MHz_t, WifiChannelListType> secondaryChannels {
...
VhtPhy::GetNumberBccEncoders(const WifiTxVector& txVector) const
{
     ...
     */
    double maxRatePerCoder = (txVector.GetGuardInterval() == NanoSeconds(800)) ? 540e6 : 600e6;
