    ...
    : CtrlTriggerHeader()
{
    ...
    if (gi == NanoSeconds(800) || gi == NanoSeconds(1600))
    {
        m_giAndLtfType = 1;
    }
    else
...
{
    if (ltfType == 1 && guardInterval == NanoSeconds(1600))
    {
        m_giAndLtfType = 0;
    }
    else if (ltfType == 2 && guardInterval == NanoSeconds(1600))
    {
        m_giAndLtfType = 1;
    }
    else if (ltfType == 4 && guardInterval == NanoSeconds(3200))
    {
        m_giAndLtfType = 2;
    }
    else
