...
WifiPhyThresholdsStrongWifiSignalTest::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (m_ccabusyStateCount, 1, "State should have moved to CCA_BUSY once");
  NS_TEST_ASSERT_MSG_EQ (m_stateChanged, 3, "State should have moved to CCA_BUSY, then to RX and finally back to IDLE");
