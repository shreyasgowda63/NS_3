 ...
 *
 * \brief A flow queue used by the Fq queue disc
 */

class FqFlow : public QueueDiscClass {
public:
  /**
...
protected:
  ...
  std::list<Ptr<FqFlow> > m_newFlows;    //!< The list of new flows
  std::list<Ptr<FqFlow> > m_oldFlows;    //!< The list of old flows
