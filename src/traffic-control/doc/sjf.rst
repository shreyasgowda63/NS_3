...
such information would be tagged to the packets prior transmission. Meanwhile, it assumes the advanced
priority queue structure which is currently not available at network switches.
