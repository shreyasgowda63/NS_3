...
3. Section 3.2.7.2, Section3.2.7.3, Section 3.2.7.4 in AccEcn draft are skipped.
...
4. Using the first algorithm in A.3 to estimate Marked Bytes from Marked Packets
   (when AccEcn option is unavailable) is not implemented, because it is hard to 
