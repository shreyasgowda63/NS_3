...
public:
   ...
   * \brief Process ARP cache according to the changes in state of NetDevice
   * 
   * \param isUp latest admin state of NetDevice
   * \param opState latest operational state of NetDevice
   */
