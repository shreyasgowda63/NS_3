...
void Ipv4RipTest::ReceivePkt (Ptr<Socket> socket)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (availableData, m_receivedPacket->GetSize (), "Cannot open file in test ");
...
void Ipv4RipSplitHorizonStrategyTest::ReceivePktProbe (Ptr<Socket> socket)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (availableData, receivedPacketProbe->GetSize (), "Cannot open file in test ");
