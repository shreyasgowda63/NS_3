...
GlobalRouteManagerImplTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (lsa2, srmlsdb->GetLSA (lsa2->GetLinkStateId ()), "Received ipv4 address initialized to 0.0.0.0 and the list of Link State Records is empty");
