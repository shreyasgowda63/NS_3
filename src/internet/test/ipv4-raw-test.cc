...
void Ipv4RawSocketImplTest::ReceivePkt (Ptr<Socket> socket)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (m_receivedPacket->GetSize (), 2, "Received packet size is equal to the Rx buffer size");
  m_receivedPacket = socket->Recv (std::numeric_limits<uint32_t>::max (), 0);
  NS_TEST_ASSERT_MSG_EQ (availableData, m_receivedPacket->GetSize (), "Received packet size is equal to the Rx buffer size");
}
...
void Ipv4RawSocketImplTest::ReceivePkt2 (Ptr<Socket> socket)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (m_receivedPacket2->GetSize (), 2, "Received packet size is equal to the Rx buffer size");
  m_receivedPacket2 = socket->Recv (std::numeric_limits<uint32_t>::max (), 0);
  NS_TEST_ASSERT_MSG_EQ (availableData, m_receivedPacket2->GetSize (), "Received packet size is equal to the Rx buffer size");
}
