...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::ThreeGppChannelModel::UpdatePeriod", TimeValue (MilliSeconds (10))); // channel update period
  Config::SetDefault ("ns3::ThreeGppChannelModel::Consistency", BooleanValue (consistency)); // enable-disable spatial consistency in the simulation
  ...
  Ptr<PhasedArrayModel> txAntenna = CreateObjectWithAttributes<UniformPlanarArray> ("NumColumns", UintegerValue (4), "NumRows", UintegerValue (4));
  Ptr<PhasedArrayModel> rxAntenna = CreateObjectWithAttributes<UniformPlanarArray> ("NumColumns", UintegerValue (4), "NumRows", UintegerValue (4));
