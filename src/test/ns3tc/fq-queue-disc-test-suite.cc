 ...
 */
class FqQueueDiscNoSuitableFilter : public TestCase
{
public:
  FqQueueDiscNoSuitableFilter ();
  virtual ~FqQueueDiscNoSuitableFilter ();

private:
  virtual void DoRun (void);
};

FqQueueDiscNoSuitableFilter::FqQueueDiscNoSuitableFilter ()
...
void
FqQueueDiscNoSuitableFilter::DoRun (void)
{
  // Packets that cannot be classified by the available filters should be dropped
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ("MaxSize", StringValue ("4p"));
 ...
 */
class FqQueueDiscIPFlowsSeparationAndPacketLimit : public TestCase
{
public:
  FqQueueDiscIPFlowsSeparationAndPacketLimit ();
  virtual ~FqQueueDiscIPFlowsSeparationAndPacketLimit ();

private:
  virtual void DoRun (void);
  void AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header hdr);
};

FqQueueDiscIPFlowsSeparationAndPacketLimit::FqQueueDiscIPFlowsSeparationAndPacketLimit ()
...
void
FqQueueDiscIPFlowsSeparationAndPacketLimit::AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header hdr)
{
...
void
FqQueueDiscIPFlowsSeparationAndPacketLimit::DoRun (void)
{
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ("MaxSize", StringValue ("4p"));
 ...
 */
class FqQueueDiscDeficit : public TestCase
{
public:
  FqQueueDiscDeficit ();
  virtual ~FqQueueDiscDeficit ();
...
FqQueueDiscDeficit::FqQueueDiscDeficit ()
...
void
FqQueueDiscDeficit::AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header hdr)
{
  Ptr<Packet> p = Create<Packet> (100);
  Address dest;
  Ptr<Ipv4QueueDiscItem> item = Create<Ipv4QueueDiscItem> (p, dest, 0, hdr);
...
void
FqQueueDiscDeficit::DoRun (void)
{
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ();
  ...
  Ptr<FqFlow> flow1 = StaticCast<FqFlow> (queueDisc->GetQueueDiscClass (0));
  ...
  NS_TEST_ASSERT_MSG_EQ (flow1->GetStatus (), FqFlow::NEW_FLOW, "the first flow must be in the list of new queues");
  // Dequeue a packet
  queueDisc->Dequeue ();
  ...
  NS_TEST_ASSERT_MSG_EQ (flow1->GetStatus (), FqFlow::NEW_FLOW, "the first flow must still be in the list of new queues");
  ...
  Ptr<FqFlow> flow2 = StaticCast<FqFlow> (queueDisc->GetQueueDiscClass (1));
  ...
  NS_TEST_ASSERT_MSG_EQ (flow2->GetStatus (), FqFlow::NEW_FLOW, "the second flow must be in the list of new queues");
  ...
  NS_TEST_ASSERT_MSG_EQ (flow1->GetStatus (), FqFlow::OLD_FLOW, "the first flow must be in the list of old queues");
  ...
  NS_TEST_ASSERT_MSG_EQ (flow2->GetStatus (), FqFlow::OLD_FLOW, "the second flow must be in the list of new queues");
  ...
  NS_TEST_ASSERT_MSG_EQ (flow1->GetDeficit (), 90, "unexpected deficit for the first flow");
  NS_TEST_ASSERT_MSG_EQ (flow1->GetStatus (), FqFlow::INACTIVE, "the first flow must be inactive");
  NS_TEST_ASSERT_MSG_EQ (flow2->GetDeficit (), 30, "unexpected deficit for the second flow");
  NS_TEST_ASSERT_MSG_EQ (flow2->GetStatus (), FqFlow::INACTIVE, "the second flow must be inactive");
 ...
 */
class FqQueueDiscTCPFlowsSeparation : public TestCase
{
public:
  FqQueueDiscTCPFlowsSeparation ();
  virtual ~FqQueueDiscTCPFlowsSeparation ();

private:
  virtual void DoRun (void);
  void AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header ipHdr, TcpHeader tcpHdr);
};

FqQueueDiscTCPFlowsSeparation::FqQueueDiscTCPFlowsSeparation ()
...
void
FqQueueDiscTCPFlowsSeparation::AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header ipHdr, TcpHeader tcpHdr)
{
  Ptr<Packet> p = Create<Packet> (100);
  p->AddHeader (tcpHdr);
  Address dest;
...
void
FqQueueDiscTCPFlowsSeparation::DoRun (void)
{
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ("MaxSize", StringValue ("10p"));
 ...
 */
class FqQueueDiscUDPFlowsSeparation : public TestCase
{
public:
  FqQueueDiscUDPFlowsSeparation ();
  virtual ~FqQueueDiscUDPFlowsSeparation ();

private:
  virtual void DoRun (void);
  void AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header ipHdr, UdpHeader udpHdr);
};

FqQueueDiscUDPFlowsSeparation::FqQueueDiscUDPFlowsSeparation ()
...
void
FqQueueDiscUDPFlowsSeparation::AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header ipHdr, UdpHeader udpHdr)
{
  Ptr<Packet> p = Create<Packet> (100);
  p->AddHeader (udpHdr);
  Address dest;
...
void
FqQueueDiscUDPFlowsSeparation::DoRun (void)
{
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ("MaxSize", StringValue ("10p"));
...
class FqQueueDiscSetLinearProbing : public TestCase
{
public:
  FqQueueDiscSetLinearProbing ();
  virtual ~FqQueueDiscSetLinearProbing ();
private:
  virtual void DoRun (void);
  void AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header hdr);
};

FqQueueDiscSetLinearProbing::FqQueueDiscSetLinearProbing ()
    : TestCase ("Test credits and flows status")
{
}
...
void
FqQueueDiscSetLinearProbing::AddPacket (Ptr<FqQueueDisc> queue, Ipv4Header hdr)
{
  Ptr<Packet> p = Create<Packet> (100);
  Address dest;
  Ptr<Ipv4QueueDiscItem> item = Create<Ipv4QueueDiscItem> (p, dest, 0, hdr);
...
void
FqQueueDiscSetLinearProbing::DoRun (void)
{
  Ptr<FqQueueDisc> queueDisc = CreateObjectWithAttributes<FqQueueDisc> ("EnableSetAssociativeHash", BooleanValue (true));
  queueDisc->SetQuantum (90);
  queueDisc->Initialize ();
...
class FqQueueDiscTestSuite : public TestSuite
{
public:
  FqQueueDiscTestSuite ();
};

FqQueueDiscTestSuite::FqQueueDiscTestSuite ()
  : TestSuite ("fq-queue-disc", UNIT)
{
  AddTestCase (new FqQueueDiscNoSuitableFilter, TestCase::QUICK);
  AddTestCase (new FqQueueDiscIPFlowsSeparationAndPacketLimit, TestCase::QUICK);
  AddTestCase (new FqQueueDiscDeficit, TestCase::QUICK);
  AddTestCase (new FqQueueDiscTCPFlowsSeparation, TestCase::QUICK);
  AddTestCase (new FqQueueDiscUDPFlowsSeparation, TestCase::QUICK);
  // AddTestCase (new FqQueueDiscECNMarking, TestCase::QUICK);
  AddTestCase (new FqQueueDiscSetLinearProbing, TestCase::QUICK);
}

static FqQueueDiscTestSuite fqQueueDiscTestSuite;