 ...
 * It configures IPv6 addresses dynamically with the radvd helper
 */

NS_LOG_COMPONENT_DEFINE ("EpcAddrAllocIpv6");
...
main (int argc, char *argv[])
{
  ...
  // ueIpIface = epcHelper->AssignUeIpv6Address (NetDeviceContainer (ueLteDevs2));

  NS_LOG_INFO ("Create networks and assign IPv6 Addresses.");
  Ipv6AddressHelper ipv6;

  /* Set Interfaces on UEs */
  ipv6.SetBase (Ipv6Address ("7777:f00d::"), Ipv6Prefix (64));
  NetDeviceContainer tmp;
  tmp.Add (ueLteDevs1); /* n0 */
  tmp.Add (ueLteDevs2);
