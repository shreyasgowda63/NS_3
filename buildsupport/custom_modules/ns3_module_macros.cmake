...
macro(
  ...
  # export include directories used by this library so that it can be used
  # by 3rd-party consumers of ns-3 using find_package(ns3)
  # this will automatically add the build/include path to them, so that they
  # can ns-3 headers with <ns3/something.h>
  target_include_directories(${lib${libname}} PUBLIC
      $<BUILD_INTERFACE:${CMAKE_OUTPUT_DIRECTORY}/include>
