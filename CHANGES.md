...
* (lte) Deprecated `{OFF, ATTACHING, IDLE_REGISTERED, CONNECTING_TO_EPC, ACTIVE}` in `EpcUeNas`. They have been replaced by `State::{OFF, ATTACHING, IDLE_REGISTERED, CONNECTING_TO_EPC, ACTIVE}`, respectively.
* (lte) Deprecated `{IDLE, TX_DL_CTRL, TX_DATA, TX_UL_SRS, RX_DL_CTRL, RX_DATA, RX_UL_SRS}` in `LteSpectrumPhy`. They have been replaced by `State::{IDLE, TX_DL_CTRL, TX_DATA, TX_UL_SRS, RX_DL_CTRL, RX_DATA, RX_UL_SRS}`, respectively.
* (lte) Deprecated `{CELL_SEARCH, SYNCHRONIZED}` in `LteUePhy`. They have been replaced by `State::{CELL_SEARCH, SYNCHRONIZED}`, respectively.
* (lte) Deprecated `{IDLE_START, IDLE_CELL_SEARCH, IDLE_WAIT_MIB_SIB1, IDLE_WAIT_MIB, IDLE_WAIT_SIB1, IDLE_CAMPED_NORMALLY, IDLE_WAIT_SIB2, IDLE_RANDOM_ACCESS, IDLE_CONNECTING, CONNECTED_NORMALLY, CONNECTED_HANDOVER, CONNECTED_PHY_PROBLEM, CONNECTED_REESTABLISHING}` in `LteUeRrc`. They have been replaced by `State::{IDLE_START, IDLE_CELL_SEARCH, IDLE_WAIT_MIB_SIB1, IDLE_WAIT_MIB, IDLE_WAIT_SIB1, IDLE_CAMPED_NORMALLY, IDLE_WAIT_SIB2, IDLE_RANDOM_ACCESS, IDLE_CONNECTING, CONNECTED_NORMALLY, CONNECTED_HANDOVER, CONNECTED_PHY_PROBLEM, CONNECTED_REESTABLISHING}`, respectively.
* (lte) Deprecated `{INITIAL_RANDOM_ACCESS, CONNECTION_SETUP, CONNECTION_REJECTED, ATTACH_REQUEST, CONNECTED_NORMALLY, CONNECTION_RECONFIGURATION, CONNECTION_REESTABLISHMENT, HANDOVER_PREPARATION, HANDOVER_JOINING, HANDOVER_PATH_SWITCH, HANDOVER_LEAVING}` in `UeManager`. They have been replaced by `State::{INITIAL_RANDOM_ACCESS, CONNECTION_SETUP, CONNECTION_REJECTED, ATTACH_REQUEST, CONNECTED_NORMALLY, CONNECTION_RECONFIGURATION, CONNECTION_REESTABLISHMENT, HANDOVER_PREPARATION, HANDOVER_JOINING, HANDOVER_PATH_SWITCH, HANDOVER_LEAVING}`, respectively.
